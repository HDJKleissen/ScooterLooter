...
public class TrainsTrainsTrains : MonoBehaviour
{
    ...
    EndScreenSprite[] sprites;
    // Start is called before the first frame update
    void Start()
    {
        sprites = new EndScreenSprite[SpritesAmount];
    ...
    void SpawnSprites()
    {
        ...
        {
            sprites[i] = Instantiate(spritePrefab).GetComponent<EndScreenSprite>();
